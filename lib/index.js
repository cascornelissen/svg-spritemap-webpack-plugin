        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            ...
            if ( stylesOptions ) {
                ...
                if ( spriteOptions.generate.symbol === true && spriteOptions.generate.view === true ) {
                    compilation.warnings.push(new OptionsMismatchWarning(`Both sprite.generate.symbol and sprite.generate.view are set to true which will cause identifier conflicts, use a prefix (string value) for either of these options`));
                }
