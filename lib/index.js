...
// Errors & Warnings
import { OptionsMismatchWarning, VariablesNotSupportedInLanguageWarning, VariablesNotSupportedWithFragmentsWarning, NoSourceFilesWarning } from './errors';
    ...
    apply(compiler) {
        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            ...
            compilation.hooks.processAssets.tap({
                ...
                const output = optimize(assets[this.filenames.spritemap].source(), config);
