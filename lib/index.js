...
module.exports = class SVGSpritemapPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.emit.tapAsync(plugin, (compilation, callback) => {
            ...
            compilation.chunks.forEach((chunk) => {
                if ( chunk.name !== outputOptions.chunk.name && !chunk.name.startsWith(`${outputOptions.chunk.name}${compilation.options.optimization.splitChunks.automaticNameDelimiter}`) ) {
                    return;
                }
