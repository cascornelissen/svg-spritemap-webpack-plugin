        ...
        compiler.hooks.make.tap(plugin, (compilation) => {
            ...
            if ( stylesOptions ) {
                ...
                if ( spriteOptions.generate.view && !spriteOptions.generate.use ) {
                    compilation.warnings.push(new OptionsMismatchWarning(`Using sprite.generate.view requires sprite.generate.use to be enabled as well to make sure CSS fragments work correctly`));
                }
