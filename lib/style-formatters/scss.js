...
module.exports = (symbols = [], options = {}) => {
    ...
    let contentOut = fs.readFileSync(path.join(__dirname, '../templates/styles.scss'), 'utf8')
    ...
    return {
        ...
        content: typeof options.callback === 'function' ? options.callback(contentOut) : contentOut
    };
};
